flowchart TD
    ...
    DriveTools --> D1["✅ List Files<br/>search_files(query)"]
    DriveTools --> D2["✅ Read Files<br/>download_file(id)"]
    DriveTools --> D3["🚧 FUTURE: Share<br/>share_file(id, email)"]
    DriveTools --> D4["🚧 FUTURE: Upload<br/>upload_file(path)"]
    DriveTools --> D5["🚧 FUTURE: Delete<br/>delete_file(id)"]
    ...
    GDocTools --> Doc1["✅ LIST Docs<br/>list_my_google_docs()"]
    GDocTools --> Doc2["✅ FIND Docs<br/>find_document_by_title(title)"]
    GDocTools --> Doc3["✅ CREATE Doc<br/>create_google_doc(title)"]
    GDocTools --> Doc4["✅ DELETE Doc<br/>find → delete_google_doc(id)"]
    GDocTools --> Doc5["✅ READ/WRITE<br/>docs_operation(id, action)"]
    GDocTools --> Doc6["✅ SHARE Doc<br/>share_google_doc(id, email)"]
    GDocTools --> Doc7["✅ VIEW Perms<br/>get_doc_permissions(id)"]
    GDocTools --> Doc8["✅ UPDATE Perms<br/>update_doc_permission(id, email, role)"]
